...
export default function GoogleSignInButton({ text = "continue_with", onCredential }: GoogleSignInButtonProps) {
  ...
  }, [clientId, onCredential, scriptReady, submitting, text])

  if (!clientId) {
    return (
      <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs text-amber-700">
        Set <span className="font-bold">VITE_GOOGLE_CLIENT_ID</span> to enable Google sign-in.
      </div>
    )
  }
